    ...
    <Card className="border border-border/50 shadow-sm">
      <CardContent className="p-6 flex flex-col items-center justify-center h-full">
        ...
        <p className="text-4xl font-bold text-foreground">
          {hours === null ? (
            <span className="text-xl font-normal text-muted-foreground italic">Awaiting model</span>
          ) : hours <= 0 ? (
            <span className="text-xl text-red-600 font-bold uppercase text-center">Discard immediately</span>
          ) : (
            <>
